...
import { UserDatatableRequest } from "@/models/User";
import { GlobalResponse } from "@/types/response";
import { useMutation, useQuery } from "@tanstack/react-query";

export const useDatatableUser = ({ onSuccess }) => {
    return useMutation({
        mutationFn: async (body : UserDatatableRequest) => {
            
            let path =  "users/datatables";
